...
export default function Home() {
  ...
  return (
    <div className="w-screen h-screen overflow-y-auto flex flex-col justify-evenly items-center bg-black font-acme py-10">
      <nav className="py-10 text-darkCream text-4xl text-center">
        Meme-Centre by Annonymous Ninja...
      </nav>
      {Loading ? (
        <SpinnerDotted color=""></SpinnerDotted>
      ) : (
        <div className="flex flex-col justify-evenly items-center  rounded shadow w-11/12 lg:w-1/2 pt-10">
          <img src={Data.url} alt={Data.title} className="w-10/12 lg:w-1/2" />
